...
from .views import homeView, aboutView, contactView,AddProduct,ProductDetails,Updateproduct,DeleteProduct # importing the views from the mainapp to access the function
#
urlpatterns =[
